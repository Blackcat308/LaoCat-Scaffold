...
(
    ...
    `username`    varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '账号',
...
VALUES ('1', 'laocat', 'f291ec5086c1b1559e6c174a755e2c70', '2022-06-23 14:55:29', NULL);
INSERT INTO `user_info`
VALUES ('1540216730991894529', 'admin', 'f291ec5086c1b1559e6c174a755e2c70', '2022-06-24 14:14:19', NULL);
...
(
    ...
    `permission_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '权限名称',
    `permission_code` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '权限code',
    `gmt_time`        datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
    `modify_time`     datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
    PRIMARY KEY (`id`) USING BTREE
...
VALUES ('1541703028546199553', '添加用户', 'insert_user', '2022-06-28 16:40:20', NULL);
...
VALUES ('1541349381446520834', '管理员', 'ROLE_ADMIN', '2022-06-27 17:15:04', NULL);
INSERT INTO `user_role`
VALUES ('1541704521814892545', '测试员', 'ROLE_TEST', '2022-06-28 16:46:16', NULL);
...
VALUES ('1', '1541349381446520834', '2022-06-28 17:38:13', NULL);
INSERT INTO `user_role_association`
VALUES ('1', '1541704521814892545', '2022-06-28 17:38:47', NULL);
